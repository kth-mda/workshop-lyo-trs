...
<head>
  ...
  <title><%= aPerson.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>Person resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aPerson.getAbout() %>"><%= aPerson.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aPerson.nameToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">givenName</dt>
            <dd class="col-sm-9"><%= aPerson.givenNameToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">familyName</dt>
            <dd class="col-sm-9"><%= aPerson.familyNameToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
