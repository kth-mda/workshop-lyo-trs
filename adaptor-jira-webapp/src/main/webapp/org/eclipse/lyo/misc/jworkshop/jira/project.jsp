...
<%@page import="org.eclipse.lyo.misc.jworkshop.jira.resources.Project"%>
<%--
...
<head>
  ...
  <title><%= aProject.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        ...
        <p class="lead">URI:&nbsp;
      <a href="<%= aProject.getAbout() %>"><%= aProject.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aProject.identifierToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">title</dt>
            <dd class="col-sm-9"><%= aProject.titleToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
