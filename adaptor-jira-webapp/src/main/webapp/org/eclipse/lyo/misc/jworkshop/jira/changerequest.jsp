...
<head>
  ...
  <title><%= aChangeRequest.toString(true) %></title>
...
<nav class="navbar sticky-top navbar-light bg-light">
  <div class="container">
  <a class="navbar-brand" href="<c:url value="/services/catalog/singleton"/>">Jira Adaptor</a>
  </div>
</nav>
...
<div class="container">
    <div class="page-header">
        <h1>Change Request resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aChangeRequest.getAbout() %>"><%= aChangeRequest.getAbout() %></a>
        </p>
    </div>
        <%--
...
End of user code
        ...
        <div>
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aChangeRequest.identifierToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">title</dt>
            <dd class="col-sm-9"><%= aChangeRequest.titleToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">description</dt>
            <dd class="col-sm-9"><%= aChangeRequest.descriptionToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">creator</dt>
            <dd class="col-sm-9"><%= aChangeRequest.creatorToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">created</dt>
            <dd class="col-sm-9"><%= aChangeRequest.createdToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">project</dt>
            <dd class="col-sm-9"><%= aChangeRequest.projectToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
