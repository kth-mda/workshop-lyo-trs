...
<head>
  ...
  <title><%= aChangeRequest.toString(false) %></title>
...
<div>
        <div>
          <dl class="dl-horizontal">
            <dt>identifier</dt>
            <dd><%= aChangeRequest.identifierToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>title</dt>
            <dd><%= aChangeRequest.titleToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>description</dt>
            <dd><%= aChangeRequest.descriptionToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>creator</dt>
            <dd><%= aChangeRequest.creatorToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>created</dt>
            <dd><%= aChangeRequest.createdToHtml()%></dd>
          </dl>
          <dl class="dl-horizontal">
            <dt>project</dt>
            <dd><%= aChangeRequest.projectToHtml()%></dd>
          </dl>
        </div>
      </div>
</body>
