...
// End of user code
@OslcService(Oslc_cmConstants.OSLC_CM_DOMAIN)
...
public class ServiceProviderService1
{
    ...
    (
        ...
        resourceShape = OslcConstants.PATH_RESOURCE_SHAPES + "/" + Oslc_cmConstants.PATH_CHANGEREQUEST,
        resourceTypes = {Oslc_cmConstants.TYPE_CHANGEREQUEST},
        usages = {}
    )
    @GET
    @Path("query")
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aChangeRequest != null) {
            ...
            largePreview.setDocument(aChangeRequest.getAbout());
