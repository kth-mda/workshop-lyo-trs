...
// End of user code
@OslcService(JiraConstants.JIRA_DOMAIN)
...
public class ServiceProviderService2
{
    ...
    (
        ...
        resourceShape = OslcConstants.PATH_RESOURCE_SHAPES + "/" + JiraConstants.PATH_PROJECT,
        resourceTypes = {JiraConstants.TYPE_PROJECT},
        usages = {}
    )
    @GET
    @Path("query")
                                    ...
                                    @QueryParam("limit") final String limitString) throws ServletException, IOException
    {
        ...
        if (resources!= null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/jira/rdf/scania/com/projectscollection.jsp");
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aProject != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/jira/rdf/scania/com/project.jsp");
            rd.forward(httpServletRequest,httpServletResponse);
        }
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aProject != null) {
            ...
            largePreview.setDocument(aProject.getAbout());
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        if (aProject != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/jira/rdf/scania/com/projectsmallpreview.jsp");
            httpServletResponse.addHeader(JiraAdaptorConstants.HDR_OSLC_VERSION, JiraAdaptorConstants.OSLC_VERSION_V2);
            rd.forward(httpServletRequest, httpServletResponse);
        }
